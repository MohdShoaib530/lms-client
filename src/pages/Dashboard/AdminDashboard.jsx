...
function AdminDashboard(){
    ...
    async function onCourseDelete(id){
        const userConfirm =  window.confirm("Are you sure want  to delete the course");
        if(!userConfirm){
            return 
        }
    ...
    return (
        <HomeLayout>
           <div className="bg-black min-h-[90vh] pt-16 flex flex-col flex-wrap gap-10  text-white ">
                <h1 className="text-3xl lg:text-5xl text-yellow-600 shadow-2xl text-center font-semibold">Admin Dashboard</h1>

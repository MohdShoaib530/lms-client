...
function Profile() {
  ...
  return (
    <HomeLayout>
      <div className="bg-[rgb(33, 33, 33)] min-h-[90vh] flex items-center justify-center ">
        <div className="py-10 flex flex-col gap-4 rounded-lg p-4 text-white w-96 border border-gray-950 mt-20 shadow-2xl">
          <img
